...
- `description` should include reusable scene, collection/resource/association context, key fields/actions, default mode, and an `auto-generated by nocobase-ui-builder` marker
