...
4. Use the snippet as guidance and write through backend `flow-surfaces`. Optional local helper checks may catch obvious issues, but snippets are not a write gate.
