...
| `ChartBlockModel` | [chart.md](chart.md) | 趋势/分布/占比/报表图 | `../page-first-planning.md` | 分析看板、趋势页、统计总览 |
| `GridCardBlockModel` | [grid-card.md](grid-card.md) | KPI 卡片、指标总览 | `../page-first-planning.md` | 总览页、经营概览、审批摘要 |
...
| 分析看板 / 趋势页 | `chart.md` `grid-card.md` `../page-first-planning.md` |
