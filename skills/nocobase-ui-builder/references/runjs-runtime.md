...
当你需要运行本地 RunJS validator / preview CLI 时，读本文。JS model 选型与代码规则看 [js.md](./js.md)。
...
```bash
node ./skills/nocobase-ui-builder/runtime/bin/nb-runjs.mjs models
node ./skills/nocobase-ui-builder/runtime/bin/nb-runjs.mjs contexts --model JSBlockModel
node ./skills/nocobase-ui-builder/runtime/bin/nb-runjs.mjs validate --stdin-json --skill-mode
node ./skills/nocobase-ui-builder/runtime/bin/nb-runjs.mjs preview --stdin-json --skill-mode
```
