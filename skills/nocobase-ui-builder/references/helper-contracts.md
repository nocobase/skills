...
- JS Template write path: multiple Hosts share one maintained implementation without copied code; independent Git storage or distribution alone keeps a single-Host implementation Inline
