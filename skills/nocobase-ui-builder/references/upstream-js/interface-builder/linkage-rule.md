...
👉 For details, see: [Block/Block Linkage Rules](./blocks/block-settings/block-linkage-rule.md)
...
👉 For details, see: [Block/Field Linkage Rules](./blocks/block-settings/field-linkage-rule.md)
...
👉 For details, see: [Action/Linkage Rules](./actions/action-settings/linkage-rule.md)
