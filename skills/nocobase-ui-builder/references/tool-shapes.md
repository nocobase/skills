...
- For `applyBlueprint`, the nb request body is one page blueprint business object. Send the raw business payload directly; do not create skill-local write-gate output, helper envelopes, or `cliBody` first.
