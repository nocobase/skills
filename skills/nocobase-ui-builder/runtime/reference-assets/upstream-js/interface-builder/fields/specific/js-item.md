...
> Local skill note: prepare final code with [js.md](../../../../../../references/js.md). If a user wants to open a popup or drawer, prefer a configured popup action or event flow outside the JS snippet instead of direct `ctx.openView(...)`.
