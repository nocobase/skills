...
> Local skill note: treat this page as a product/runtime reference. Prepare final code with [js.md](../../../../../../references/js.md). Under this skill, do not emit direct `ctx.openView(...)` as the final answer; prefer popup actions, field popups, or event flows outside the JS snippet.
