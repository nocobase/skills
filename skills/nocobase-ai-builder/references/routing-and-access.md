...
- When replacing the starter application, hide demo menu entries through application-level resource/navigation composition rather than deleting installed extension source.
