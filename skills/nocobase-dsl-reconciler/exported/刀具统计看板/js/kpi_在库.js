// KPI: 在库
const CONFIG = {
  label: '在库', color: '#10b981', bgColor: '#ecfdf5', strokeColor: '#a7f3d0',
  format: 'number', dataSourceKey: 'main', reportUid: 'tm_kpi_instock',
  sql: `
SELECT COUNT(*) AS value,
  ROUND(COUNT(*)::numeric * 100 / NULLIF((SELECT COUNT(*) FROM nb_tm_tools), 0), 0) || '%' AS sub_text
