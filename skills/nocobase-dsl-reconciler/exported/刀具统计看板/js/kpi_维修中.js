// KPI: 维修中
const CONFIG = {
  label: '维修中', color: '#f59e0b', bgColor: '#fffbeb', strokeColor: '#fde68a',
  format: 'number', dataSourceKey: 'main', reportUid: 'tm_kpi_repair',
  sql: `SELECT COUNT(*) AS value, '' AS sub_text FROM nb_tm_repair WHERE status = '维修中'`,
};
