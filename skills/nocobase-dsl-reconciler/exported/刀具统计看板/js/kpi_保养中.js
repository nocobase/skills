// KPI: 保养中
const CONFIG = {
  label: '保养中', color: '#8b5cf6', bgColor: '#f5f3ff', strokeColor: '#ddd6fe',
  format: 'number', dataSourceKey: 'main', reportUid: 'tm_kpi_maint',
  sql: `SELECT COUNT(*) AS value, '' AS sub_text FROM nb_tm_tools WHERE status = '保养中'`,
};
