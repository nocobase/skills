// KPI: 使用中
const CONFIG = {
  label: '使用中', color: '#3b82f6', bgColor: '#eff6ff', strokeColor: '#bfdbfe',
  format: 'number', dataSourceKey: 'main', reportUid: 'tm_kpi_inuse',
  sql: `SELECT COUNT(*) AS value, '' AS sub_text FROM nb_tm_tools WHERE status = '使用中'`,
};
