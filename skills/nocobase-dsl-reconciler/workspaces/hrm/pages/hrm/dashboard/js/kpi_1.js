...
var CONFIG = {
  dataSourceKey: 'main',
  reportUid: 'hrm_kpi_1',
  sql: 'SELECT COUNT(id) AS value FROM "nb_hrm_departments"',
  label: 'Departments',
  color: '#3b82f6',
};
...
var KpiCard = function() {
  ...
  return React.createElement('div', { className: 'kpi-card-hover', style: cardStyle },
    ...
    React.createElement('svg', { style: bgChartStyle, viewBox: '0 0 100 50', preserveAspectRatio: 'none' },
      React.createElement('path', { d: 'M0,50 L0,30 Q25,10 50,25 T100,15 L100,50 Z', fill: '#eff6ff', stroke: '#bfdbfe', strokeWidth: '2' }))
  );
};
