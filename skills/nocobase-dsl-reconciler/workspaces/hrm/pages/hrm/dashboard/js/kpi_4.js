...
var CONFIG = {
  dataSourceKey: 'main',
  reportUid: 'hrm_kpi_4',
  sql: 'SELECT COUNT(id) AS value FROM "nb_hrm_leave_requests" WHERE status = \'pending\'',
...
var KpiCard = function() {
  ...
  return React.createElement('div', { className: 'kpi-card-hover', style: cardStyle },
    ...
    React.createElement('svg', { style: bgChartStyle, viewBox: '0 0 100 50', preserveAspectRatio: 'none' },
      React.createElement('path', { d: 'M0,50 L0,20 Q25,40 50,25 T100,35 L100,50 Z', fill: '#fef2f2', stroke: '#fecaca', strokeWidth: '2' }))
  );
};
