...
var CONFIG = {
  dataSourceKey: 'main',
  reportUid: 'hrm_kpi_3',
  sql: "SELECT COUNT(*) AS value FROM nb_hrm_leave_requests WHERE status = 'pending'",
  label: 'Pending Leave',
  color: '#f59e0b',
};
...
var KpiCard = function() {
  ...
  return React.createElement('div', { className: 'kpi-card-hover', style: cardStyle },
    ...
    React.createElement('svg', { style: bgChartStyle, viewBox: '0 0 100 50', preserveAspectRatio: 'none' },
      React.createElement('path', { d: 'M0,50 L0,30 Q25,10 50,25 T100,15 L100,50 Z', fill: '#fffbeb', stroke: '#fcd34d', strokeWidth: '2' }))
  );
};
