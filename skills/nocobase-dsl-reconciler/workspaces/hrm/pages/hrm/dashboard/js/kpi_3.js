...
var CONFIG = {
  dataSourceKey: 'main',
  reportUid: 'hrm_kpi_3',
  sql: 'SELECT COUNT(id) AS value FROM "nb_hrm_employees" WHERE status = \'active\'',
...
var KpiCard = function() {
  ...
  return React.createElement('div', { className: 'kpi-card-hover', style: cardStyle },
    ...
    React.createElement('svg', { style: bgChartStyle, viewBox: '0 0 100 50', preserveAspectRatio: 'none' },
      React.createElement('path', { d: 'M0,50 L0,25 Q25,5 50,20 T100,10 L100,50 Z', fill: '#fffbeb', stroke: '#fde68a', strokeWidth: '2' }))
  );
};
