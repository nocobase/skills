...
var CONFIG = {
  dataSourceKey: 'main',
  reportUid: 'hrm_kpi_2',
  sql: 'SELECT COUNT(id) AS value FROM "nb_hrm_employees"',
...
var KpiCard = function() {
  ...
  return React.createElement('div', { className: 'kpi-card-hover', style: cardStyle },
    ...
    React.createElement('svg', { style: bgChartStyle, viewBox: '0 0 100 50', preserveAspectRatio: 'none' },
      React.createElement('path', { d: 'M0,50 L0,35 Q25,15 50,30 T100,20 L100,50 Z', fill: '#ecfdf5', stroke: '#a7f3d0', strokeWidth: '2' }))
  );
};
