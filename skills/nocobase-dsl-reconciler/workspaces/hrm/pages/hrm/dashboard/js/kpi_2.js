...
var CONFIG = {
  dataSourceKey: 'main',
  reportUid: 'hrm_kpi_2',
  sql: "SELECT COUNT(*) AS value FROM nb_hrm_departments WHERE status = 'active'",
...
var KpiCard = function() {
  ...
  return React.createElement('div', { className: 'kpi-card-hover', style: cardStyle },
    ...
    React.createElement('svg', { style: bgChartStyle, viewBox: '0 0 100 50', preserveAspectRatio: 'none' },
      React.createElement('path', { d: 'M0,50 L0,30 Q25,10 50,25 T100,15 L100,50 Z', fill: '#ecfdf5', stroke: '#6ee7b7', strokeWidth: '2' }))
  );
};
