...
const CONFIG = {
  resource: 'nb_hrm_attendance:list',
  stats: [
    { key: 'all', label: 'All', filter: null },
    { key: 'present', label: 'Present', filter: { attendance_status: { $eq: 'present' } } },
    { key: 'late', label: 'Late', filter: { attendance_status: { $eq: 'late' } } },
    { key: 'remote', label: 'Remote', filter: { attendance_status: { $eq: 'remote' } } },
    { key: 'absent', label: 'Absent', filter: { attendance_status: { $eq: 'absent' } } },
    { key: 'on_leave', label: 'On Leave', filter: { attendance_status: { $eq: 'on_leave' } } },
  ],
};
