...
const STATS = [
  ...
  { key: 'on_leave', label: 'On Leave', filter: { status: { $eq: 'on_leave' } }, group: 'status' },
  { key: 'resigned', label: 'Resigned', filter: { status: { $eq: 'resigned' } }, group: 'status' },
];
