...
var CONFIG = {
  dataSourceKey: 'main',
  reportUid: 'erp_dashboard_total_sales',
  sql: "SELECT COALESCE(SUM(total_amount), 0) AS value FROM nb_erp_customer_orders WHERE status IN ('confirmed', 'picking', 'shipped', 'completed')",
  label: 'Total Sales',
  color: '#0f766e',
  prefix: '$',
};
