...
const STATS = [
  ...
  { key: 'todo', label: 'To Do', filter: { status: { $eq: 'todo' } }, group: 'status' },
  { key: 'in_progress', label: 'In Progress', filter: { status: { $eq: 'in_progress' } }, group: 'status' },
  { key: 'review', label: 'Review', filter: { status: { $eq: 'review' } }, group: 'status' },
  { key: 'done', label: 'Done', filter: { status: { $eq: 'done' } }, group: 'status' },
];
