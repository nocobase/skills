...
const CONFIG = {
  ...
  format: 'number',
  dataSourceKey: 'main',
  reportUid: 'helpdesk_kpi_avg_resolution',
  sql: `SELECT COALESCE(ROUND(AVG(EXTRACT(EPOCH FROM ("updatedAt" - "createdAt")) / 3600), 1), 0) AS value FROM "nb_helpdesk_tickets" WHERE "status" = 'Closed' AND "updatedAt" > NOW() - '30 days'::interval`
};
// ==================== END CONFIG ====================
