...
| `custom-action` | 自定义操作事件 | plugin-workflow-custom-action-trigger | [custom-action-trigger.md](custom-action-trigger.md) |
| `request-interception` | 操作前事件 | plugin-workflow-request-interceptor | [request-interception-trigger.md](request-interception-trigger.md) |
