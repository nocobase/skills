...
- `nocobase-page-builder`: page building with XML markup DSL, Python client library, JS auto-generation, ECharts support.
- `nocobase-app-builder`: **orchestrator** — guides agents through phased application building (data modeling → page building → workflows → permissions), directing to the correct skill at each step.
